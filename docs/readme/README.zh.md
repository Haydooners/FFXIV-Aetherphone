...
Aetherphone 是一款免费、开源的 Dalamud 插件，在 FINAL FANTASY XIV 中把一部真正的智能手机搬上屏幕：一台停靠、常驻显示的设备，配有主屏幕、应用切换器、通知、铃声以及可换主题的壁纸。应用背后运行着一个面向 Aetherphone 用户的社交网络，因此它们可以跨角色、跨会话工作，而不仅限于本地。
...
- **专属于你**：任意强调色、壁纸、Lodestone 角色立绘、自定义铃声、轻巧的界面音效、文字大小缩放，以及可以随意拖拽大小的手机。最小化时只显示你挑选的内容，顺序也由你决定：时钟、日期、正在播放、通话、通知卡片、未读标记，以及艾欧泽亚时间、天气、下次重置、金币、Aether Coin、雇员探险和活跃度圆环等小组件，还可以把壁纸垫在后面。它也可以改为收起成实时的区域小地图，提供三种大小，能顶替界面上游戏自带的小地图。
