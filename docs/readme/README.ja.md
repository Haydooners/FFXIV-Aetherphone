...
Aetherphone は、FINAL FANTASY XIV の画面上に本物のスマートフォンを置く、無料でオープンソースの Dalamud プラグインです。ホーム画面、アプリスイッチャー、通知、着信音、テーマ変更できる壁紙を備えた、ドッキングされ常時表示されるデバイスです。アプリの背後では Aetherphone ユーザー向けの独自のソーシャルネットワークが動作しており、ローカルだけでなくキャラクターやセッションをまたいで機能します。
...
- **自分好みに**：好きなアクセントカラー、壁紙、Lodestone のキャラクターポートレート、カスタム着信音、控えめな操作音、文字サイズのズーム、そして好きな大きさにドラッグできるスマホ。最小化中は、選んだ項目だけを好きな並び順で表示します：時計、日付、再生中、通話、通知カード、未読バッジ、さらにエオルゼア時間、天候、次のリセット、ギル、Aether Coin、リテイナー探索、アクティビティリングのウィジェット。壁紙を背景に敷くこともできます。代わりにエリアのミニマップへ折りたためて、大きさは3種類、ゲームのミニマップの位置に置けます。
