...
- **Social**: a microblog, a photo feed, and ChocoChat, a WhatsApp-style messenger with voice notes, group chats (photos, descriptions and admins), chat themes, wallpapers and group calls, plus an optional 18+ companion app. Any ChocoChat conversation pops out into its own floating window from the more options menu, so it keeps going while the phone is closed.
